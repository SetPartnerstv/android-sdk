...
/**
 * Protobuf type {@code pbv1.ApplePayPaymentToken}
 */
public final class ApplePayPaymentToken extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:pbv1.ApplePayPaymentToken)
...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26: {
            ru.gazprombonus.sdk.model.ApplePaymentMethod.Builder subBuilder = null;
            if (paymentMethod_ != null) {
              subBuilder = paymentMethod_.toBuilder();
            }
            paymentMethod_ = input.readMessage(ru.gazprombonus.sdk.model.ApplePaymentMethod.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ru.gazprombonus.sdk.model.Mobile.internal_static_pbv1_ApplePayPaymentToken_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return ru.gazprombonus.sdk.model.Mobile.internal_static_pbv1_ApplePayPaymentToken_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            ru.gazprombonus.sdk.model.ApplePayPaymentToken.class, ru.gazprombonus.sdk.model.ApplePayPaymentToken.Builder.class);
  }
  ...
  private ru.gazprombonus.sdk.model.ApplePaymentMethod paymentMethod_;
  /**
   ...
   */
  @java.lang.Override
  public ru.gazprombonus.sdk.model.ApplePaymentMethod getPaymentMethod() {
    return paymentMethod_ == null ? ru.gazprombonus.sdk.model.ApplePaymentMethod.getDefaultInstance() : paymentMethod_;
  }
  /**
   * <code>.pbv1.ApplePaymentMethod payment_method = 3;</code>
   */
  @java.lang.Override
  public ru.gazprombonus.sdk.model.ApplePaymentMethodOrBuilder getPaymentMethodOrBuilder() {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof ru.gazprombonus.sdk.model.ApplePayPaymentToken)) {
      return super.equals(obj);
    }
    ru.gazprombonus.sdk.model.ApplePayPaymentToken other = (ru.gazprombonus.sdk.model.ApplePayPaymentToken) obj;
  ...
  public static ru.gazprombonus.sdk.model.ApplePayPaymentToken parseFrom(
  ...
  public static ru.gazprombonus.sdk.model.ApplePayPaymentToken parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static ru.gazprombonus.sdk.model.ApplePayPaymentToken parseFrom(
  ...
  public static ru.gazprombonus.sdk.model.ApplePayPaymentToken parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static ru.gazprombonus.sdk.model.ApplePayPaymentToken parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static ru.gazprombonus.sdk.model.ApplePayPaymentToken parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(ru.gazprombonus.sdk.model.ApplePayPaymentToken prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:pbv1.ApplePayPaymentToken)
      ru.gazprombonus.sdk.model.ApplePayPaymentTokenOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return ru.gazprombonus.sdk.model.Mobile.internal_static_pbv1_ApplePayPaymentToken_descriptor;
    }
    ...
    // Construct using ru.gazprombonus.sdk.model.ApplePayPaymentToken.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public ru.gazprombonus.sdk.model.ApplePayPaymentToken getDefaultInstanceForType() {
      return ru.gazprombonus.sdk.model.ApplePayPaymentToken.getDefaultInstance();
    }

    @java.lang.Override
    public ru.gazprombonus.sdk.model.ApplePayPaymentToken build() {
      ru.gazprombonus.sdk.model.ApplePayPaymentToken result = buildPartial();
    ...
    @java.lang.Override
    public ru.gazprombonus.sdk.model.ApplePayPaymentToken buildPartial() {
      ru.gazprombonus.sdk.model.ApplePayPaymentToken result = new ru.gazprombonus.sdk.model.ApplePayPaymentToken(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof ru.gazprombonus.sdk.model.ApplePayPaymentToken) {
        return mergeFrom((ru.gazprombonus.sdk.model.ApplePayPaymentToken)other);
      } else {
    ...
    public Builder mergeFrom(ru.gazprombonus.sdk.model.ApplePayPaymentToken other) {
      if (other == ru.gazprombonus.sdk.model.ApplePayPaymentToken.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      ru.gazprombonus.sdk.model.ApplePayPaymentToken parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (ru.gazprombonus.sdk.model.ApplePayPaymentToken) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        ru.gazprombonus.sdk.model.ApplePaymentMethod, ru.gazprombonus.sdk.model.ApplePaymentMethod.Builder, ru.gazprombonus.sdk.model.ApplePaymentMethodOrBuilder> paymentMethodBuilder_;
    /**
     * <code>.pbv1.ApplePaymentMethod payment_method = 3;</code>
     * @return Whether the paymentMethod field is set.
     */
     ...
     * <code>.pbv1.ApplePaymentMethod payment_method = 3;</code>
     */
    public Builder setPaymentMethod(ru.gazprombonus.sdk.model.ApplePaymentMethod value) {
      if (paymentMethodBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setPaymentMethod(
        ru.gazprombonus.sdk.model.ApplePaymentMethod.Builder builderForValue) {
      if (paymentMethodBuilder_ == null) {
     ...
     * <code>.pbv1.ApplePaymentMethod payment_method = 3;</code>
     */
    public Builder mergePaymentMethod(ru.gazprombonus.sdk.model.ApplePaymentMethod value) {
      if (paymentMethodBuilder_ == null) {
        if (paymentMethod_ != null) {
          paymentMethod_ =
            ru.gazprombonus.sdk.model.ApplePaymentMethod.newBuilder(paymentMethod_).mergeFrom(value).buildPartial();
        } else {
          paymentMethod_ = value;
        }
        onChanged();
     ...
     * <code>.pbv1.ApplePaymentMethod payment_method = 3;</code>
     */
    public ru.gazprombonus.sdk.model.ApplePaymentMethod.Builder getPaymentMethodBuilder() {
    ...
    public ru.gazprombonus.sdk.model.ApplePaymentMethodOrBuilder getPaymentMethodOrBuilder() {
      if (paymentMethodBuilder_ != null) {
        ...
        return paymentMethod_ == null ?
            ru.gazprombonus.sdk.model.ApplePaymentMethod.getDefaultInstance() : paymentMethod_;
      }
    }
    /**
     * <code>.pbv1.ApplePaymentMethod payment_method = 3;</code>
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        ru.gazprombonus.sdk.model.ApplePaymentMethod, ru.gazprombonus.sdk.model.ApplePaymentMethod.Builder, ru.gazprombonus.sdk.model.ApplePaymentMethodOrBuilder> 
    ...
    // @@protoc_insertion_point(builder_scope:pbv1.ApplePayPaymentToken)
  }

  // @@protoc_insertion_point(class_scope:pbv1.ApplePayPaymentToken)
  private static final ru.gazprombonus.sdk.model.ApplePayPaymentToken DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ru.gazprombonus.sdk.model.ApplePayPaymentToken();
  }

  public static ru.gazprombonus.sdk.model.ApplePayPaymentToken getDefaultInstance() {
